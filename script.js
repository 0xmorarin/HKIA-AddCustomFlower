...
// Each game version keeps its own fully verified code template.
// To add a new update, add one new profile here. The version selector
// automatically sorts versions numerically and selects the newest one.
const VERSION_PROFILES = {
  "2.17.1": {
    bid: "47797CD0C232F47C",
    template: [
      "[CHEAT_NAME]",
      "04000000 083B178C F0015C20",
      "08000000 083B1790 97A917FF F9435800",
      "08000000 083B1798 F9401C00 F9401800",
      "08000000 083B17A0 528014A8 F9401400",
      "08000000 083B17A8 A9434FF4 39008C08",
      "08000000 083B17B0 39408E68 16D12A5E",
      "08000000 083B17B8 54000321 7102951F",
      "08000000 083B17C0 A9BF57F4 39008E7F",
      "08000000 083B17C8 {FLOWER_MOVK} {FLOWER_MOVZ}",
      "08000000 083B17D0 96CC5EB7 2A1403E0",
      "08000000 083B17D8 {GROW} AA0003F5",
      "08000000 083B17E0 {BASE_COLOR} 390042A8",
      "08000000 083B17E8 {SPECIAL} B90016A8",
      "08000000 083B17F0 {PATTERN_COLOR} B9001AA8",
      "08000000 083B17F8 AA1303E0 B9001EA8",
      "08000000 083B1800 F9405000 96B24754",
      "08000000 083B1808 AA1503E2 2A1403E1",
      "08000000 083B1810 52800044 {QUANTITY}",
      "08000000 083B1818 A8C157F4 96B19DEE",
      "08000000 083B1820 16B287B6 A94227E8",
      "04000000 037FC124 152ED59A",
      "04000000 030536F8 154D782F"
    ]
  }
};
...
function buildReplacementMap() {
  ...
  return {
    ...
    "{BASE_COLOR}": hex8(movzW(8, COLORS[$("baseColor").value])),
    "{SPECIAL}": hex8(movzW(8, specialIndex)),
    "{PATTERN_COLOR}": hex8(movzW(8, patternColorIndex)),
